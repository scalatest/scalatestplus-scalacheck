...
To use it for ScalaTest 3.2.20 and ScalaCheck 1.20.x: 

SBT: 

```
libraryDependencies += "org.scalatestplus" %% "scalacheck-1-20" % "3.2.20.0" % "test"
```
...
<dependency>
  ...
  <artifactId>scalacheck-1-20_3</artifactId>
